	...
	return (
		<>
			{location?.includes("第1体育館") && (
				<>
					<div className="absolute inset-0 w-5 h-5 bg-red-400 rounded-[50%_50%_50%_0] rotate-[-45deg] animate-ping opacity-75 mt-37 ml-31.5" />
			...
			{location?.includes("第2体育館") && (
				<>
					<div className="absolute inset-0 w-5 h-5 bg-red-400 rounded-[50%_50%_50%_0] rotate-[-45deg] animate-ping opacity-75 mt-44.5 ml-9" />
			...
			{location?.includes("陸上グラウンド") && (
				<>
					<div className="absolute inset-0 w-5 h-5 bg-red-400 rounded-[50%_50%_50%_0] rotate-[-45deg] animate-ping opacity-75 mt-18.5 ml-58" />
			...
			{(location === "テニスコートA" || location === "テニスコートB") && (
				<>
					<div className="absolute inset-0 w-5 h-5 bg-red-400 rounded-[50%_50%_50%_0] rotate-[-45deg] animate-ping opacity-75 mt-58.5 ml-40" />
			...
			{(location === "テニスコートC" || location === "テニスコートD") && (
				<>
					<div className="absolute inset-0 w-5 h-5 bg-red-400 rounded-[50%_50%_50%_0] rotate-[-45deg] animate-ping opacity-75 mt-55.5 ml-60" />
			...
			{location?.includes("野球グラウンド") && (
				<>
					<div className="absolute inset-0 w-5 h-5 bg-red-400 rounded-[50%_50%_50%_0] rotate-[-45deg] animate-ping opacity-75 mt-74.5 ml-69" />
