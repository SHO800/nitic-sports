    ...
    <div className="flex flex-row px-1 justify-center">
        {(today <= 22) && (
            <>
                ...
                <button onClick={() => setSelectedId(5)} className={`text-sm rounded-t px-2 py-1 border-r border-black ${selectedId === 5 ? "bg-blue-200 text-black" : "bg-blue-400 text-white border-b"}`}>テニス</button>
                <button onClick={() => setSelectedId(6)} className={`text-sm rounded-t px-2 py-1 border-r border-black ${selectedId === 6 ? "bg-blue-200 text-black" : "bg-blue-400 text-white border-b"}`}>ソフト</button>
                <button onClick={() => setSelectedId(7)} className={`text-sm rounded-t px-2 py-1 border-r border-black ${selectedId === 7 ? "bg-blue-200 text-black" : "bg-blue-400 text-white border-b"}`}>サッカー</button>
                ...
                <button onClick={() => setSelectedId("all")} className={`text-sm rounded-t px-2 py-1 border-r border-black ${selectedId === "all" ? "bg-blue-200 text-black" : "bg-blue-400 text-white border-b"}`}>全競技</button>
            </>
        )}
        {(today >= 23) && (
            <>
