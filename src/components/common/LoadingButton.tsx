...
const LoadingButton = ({children, onClick, bgColor, textColor = "white", isLoading}: {children: ReactNode, onClick: () => void, bgColor: string, textColor: string, isLoading: boolean}) => {
