...
const TournamentLine: React.FC<TournamentLineProps> = ({
    ...
    const lineStyle = useMemo(() => {
        ...
        return baseStyle;
    }, [type, startX, startY, endX, endY, duration, animationTimingFunction, timeout]);
    ...
    // 以下、角のある線は共通コンポーネントに変更
        ...
        return (
            <CornerLine
                ...
                line2={{x1: 0, y1: endY - startY, x2: endX - startX, y2: endY - startY}}
            />
        );
    } else if (type === 'RT') {
        return (
            <CornerLine
                ...
                line2={{x1: endX - startX, y1: 0, x2: endX - startX, y2: endY - startY}}
            />
        );
    } else if (type === 'LB') {
        return (
        ...
        return (
            <CornerLine
                ...
                duration={duration}
                timeout={timeout}
                line1={{x1: 0, y1: endY - startY, x2: endX - startX, y2: endY - startY}}
                line2={{x1: endX - startX, y1: endY - startY, x2: endX - startX, y2: 0}}
            />
        );
    } else if (type === 'DIRECT') {
        return (
